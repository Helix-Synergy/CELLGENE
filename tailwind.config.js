  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        /* 🎨 Supporting / UI */
        sky: "rgba(124, 200, 250, 0.1)",     // Light sky-blue glow
        orange: "rgba(124, 200, 250, 0.4)",  // Muted highlight
        lightGreen: "rgba(124, 200, 250, 0.2)",
